...
$(builddir)/v8_shell: LD_INPUTS := $(OBJS) $(obj).target/tools/gyp/libv8_base.a $(obj).target/tools/gyp/libv8_snapshot.a
$(builddir)/v8_shell: TOOLSET := $(TOOLSET)
$(builddir)/v8_shell: $(OBJS) $(obj).target/tools/gyp/libv8_base.a $(obj).target/tools/gyp/libv8_snapshot.a FORCE_DO_CMD
	$(call do_cmd,link)
